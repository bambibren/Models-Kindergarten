...
describe("PptxBuildService", () => {
  it.runIf(process.platform === "darwin")("使用真实 PptxGenJS 在 macOS 受控进程中生成 PPTX", async () => {
...
`);
  ...
  it("执行源码并返回指定 PPTX 的哈希、字节和页数", async () => {
