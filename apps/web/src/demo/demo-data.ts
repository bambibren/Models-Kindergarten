...
export const demoModelStudents: DemoModelStudent[] = [
  {
    ...
    capabilities: { streaming: "supported", toolCalls: "supported", reasoning: "supported", usage: "supported", reasoningControl: { schemaVersion: 1, control: "toggle", adjustable: true, supportedProfiles: ["fast", "balanced"], defaultProfile: "balanced", native: { parameter: "think", values: [false, true] } } },
    score: 53,
    state: "在读",
  },
  {
    ...
    protocol: "ollama_native",
    baseUrl: "http://127.0.0.1:11434",
    capabilities: { streaming: "supported", toolCalls: "unverified", reasoning: "supported", usage: "supported", reasoningControl: { schemaVersion: 1, control: "fixed", adjustable: false, supportedProfiles: ["deep"], defaultProfile: "deep" } },
    score: 47,
    state: "旁听",
  },
  {
    ...
    capabilities: { streaming: "supported", toolCalls: "supported", reasoning: "unverified", usage: "supported", reasoningControl: { schemaVersion: 1, control: "fixed", adjustable: false, supportedProfiles: ["balanced"], defaultProfile: "balanced" } },
    score: null,
    state: "待评测",
  },
];
