...
export function MePage() {
  ...
  const [activeTab, setActiveTab] = useState<MeTab>(tabs.some((tab) => tab.id === requestedTab) ? requestedTab! : "agents");
  ...
  return <main className="mk-demo-app mk-me-page">
    ...
    <div className="mk-me-shell">
      ...
      <section className="mk-me-content">
        ...
        {activeTab === "agents" ? <AgentPanel agents={agents} /> : activeTab === "mcps" ? <McpPanel installations={mcps} /> : activeTab === "skills" ? <SkillPanel onRefresh={() => setSkills(listDemoSkills(sessionStorage))} skills={skills} /> : <ModelPanel models={models} />}
      </section>
    </div>
  </main>;
}
